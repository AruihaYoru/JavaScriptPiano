async function createDecoder(moduleArg = {}) {
    var moduleRtn;
    ...
    function findWasmBinary() {
        if (Module["locateFile"]) {
            return locateFile("wav_decoder.wasm")
        }
        return new URL("wav_decoder.wasm", import.meta.url).href
    }
    ...
    function assignWasmExports(wasmExports) {
        _free = Module["_free"] = wasmExports["e"];
        _decode_wav = Module["_decode_wav"] = wasmExports["f"];
